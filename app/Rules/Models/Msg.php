 ...
 //                                   'text' => $tempButton->body,
   //                             ]],
    ...
    //                    $components[] = json_encode($button);
            ...
            $checkOptIn = (new WhatsAppUsers)->checkUserOptin($destination , $account->src_name);
            if(! $checkOptIn){
            ...
            if($templateId && $templateId != "undefined" ){  
                ...
                if($tempMessage->header_type != 'text' && $tempMessage->header_type) {
                    $postDataMessage = json_encode([
                        'type' => $tempMessage->header_type,
                        $tempMessage->header_type => [
                            'link' => 'link_url', 
                        ],
                    ]);
