...
import { ChevronDownIcon, ChevronUpIcon, UserAddIcon, PencilAltIcon, TrashIcon, UploadIcon, DownloadIcon, CollectionIcon, BriefcaseIcon, MenuIcon } from '@heroicons/react/solid';
                    ...
                    <div className='flex gap-3 align-self-center'>
                        {props.actions && props.actions.invite_user === true ?
                            <>
                                ...
                                > 
                                  <div className='flex'> <UserAddIcon className='h-4 w-4 mr-1' /> {props.translator['Invite Users']} </div>
                                </Button>
                            </>
                        : ''}
              ...
              <div className="px-1 py-1 ">
                ...
                {props.actions && props.actions.export === true &&
                    ...
                    {({ active }) => (
                        <button className=' items-center'>
                            ...
                            >
                                <UploadIcon className='h-4 w-4 text-indigo-700' /> {props.translator['Export']} 
                            </a>
                ...
                {props.actions && props.actions.import === true &&
                    ...
                    {({ active }) => (
                        <Link 
                          ...
                          className='d-flex gap-1 items-center px-4 py-2 font-semibold text-sm text-gray-700 hover:text-indigo-700'
                        > 
                           <DownloadIcon className='h-4 w-4 cursor-pointer text-indigo-700' /> {props.translator['Import']} 
                        </Link>
                    )}
                    </Menu.Item>
                }
                {(props.module!=='Transaction' && props.module!=='Msg' && props.actions && props.actions.mass_edit === true) &&
                    ...
                    {({ active }) => (
                         ...
                         >
                           <PencilAltIcon className='h-4 w-4 text-indigo-700' />  {props.translator['Mass edit']}
                        </button>
                    )}
                    </Menu.Item>
                }
