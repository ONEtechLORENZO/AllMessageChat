                        ...
                        >
                            ...
                            <div className="fixed inset-0 overflow-y-auto">
                                <div className="flex min-h-full items-center justify-center p-4 text-center">
                                    ...
                                    >
                                        <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl border border-white/10 bg-[#120b1f]/95 text-left align-middle shadow-2xl transition-all">
                                            <Dialog.Title
                                                as="h3"
                                                className="flex items-center gap-2 border-b border-white/10 px-6 py-4 text-lg font-semibold text-white"
                                            >
                                                Conversation prices
                                                <FiInfo className="text-white/70" />
                                            </Dialog.Title>
                                            <div className="space-y-5 px-6 py-5 text-white/80">
                                                <p className="text-sm leading-relaxed text-white/70">
                                                    It means a conversation
                                                    started by a user or by your
                                                    business and lasting a
                                                    maximum of 24 hours, after
                                                    24 hours a new conversation
                                                    is counted.
                                                </p>
                                                ...
                                                <div className="flex justify-between items-center">
                                                    <div className="flex !gap-3">
                                                        ...
                                                        >
                                                            <path
                                                                d="M11.998 2C6.35805 2 1.99805 6.13 1.99805 11.7C1.99805 14.61 3.18805 17.14 5.13805 18.87C5.29805 19 5.39805 19.22 5.40805 19.44L5.45805 21.22C5.49805 21.79 6.06805 22.16 6.58805 21.93L8.56805 21.06C8.73805 21 8.92805 20.97 9.09805 21C9.99805 21.27 10.998 21.4 11.998 21.4C17.638 21.4 21.998 17.27 21.998 11.7C21.998 6.13 17.638 2 11.998 2ZM17.998 9.46L15.068 14.13C14.598 14.86 13.598 15.05 12.898 14.5L10.558 12.77C10.4542 12.6921 10.3279 12.65 10.198 12.65C10.0682 12.65 9.9419 12.6921 9.83805 12.77L6.67805 15.17C6.25805 15.5 5.70805 15 5.99805 14.54L8.92805 9.87C9.39805 9.14 10.398 8.95 11.098 9.47L13.438 11.23C13.5419 11.3079 13.6682 11.35 13.798 11.35C13.9279 11.35 14.0542 11.3079 14.158 11.23L17.318 8.83C17.738 8.5 18.288 9 17.998 9.46Z"
                                                                fill="#BF00FF"
                                                            />
                                                        </svg>
                                                    </div>
