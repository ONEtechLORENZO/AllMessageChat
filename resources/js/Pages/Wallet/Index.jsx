                ...
                <div className="sm:grid grid-cols-2 gap-4 mt-4">
                    ...
                    <Card className="main-card">
                        ...
                        <div className="grid grid-cols-1 gap-4 mt-4">
                            <Card className="main-card">
                                <CardBody className=" rounded-md  w-full  p-4 justify-center md:justify-start">
                        ...
                        {(props.message_accoount_detail).map(account => {
                            return(
                                <div className="grid grid-cols-1 gap-4 mt-4">
                                    <div className="bg-white rounded-md shadow w-full space-y-6 p-4 md:p-8 flex flex-col justify-center md:justify-start">
...
{/*                         
                    ...
                    <div className="space-y-4 ">
                        <div className="bg-white rounded-md shadow w-full p-4 md:p-8">
                            <span className="font-semibold text-base">
...
{/* 
                        <div className="bg-white rounded-md shadow w-full flex justify-between items-center p-4 md:p-8">
