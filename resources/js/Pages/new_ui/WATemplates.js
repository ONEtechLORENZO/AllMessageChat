        ...
        <div className="col-span-6">
          ...
          <Card className='!mt-6 p-6'>
            ...
            <div className='!mt-2 space-y-3'>
              ...
              <div className='form-group'>
                <label className='text-[#424242] text-base font-medium'>Name</label>
                <select name="select"  class="form-select !w-1/2"><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option></select>
              </div>
              <div className='form-group'>
          ...
          <Card className='!mt-4 p-6'>
            ...
            <div className='space-y-3'>            
                ...
                <div className='form-group'>
                    ...
                    <textarea name="text" class="form-control" maxLength={'1024'}></textarea>
                    <small class="form-text text-muted" >Max 1024 characters </small>
                </div>
                <div className='form-group'>
              ...
              <div className='button-container space-y-3'>
                ...
                <div className='form-group'>
                  ...
                  <small class="form-text text-muted">Fomat: +XXXXXXXXXX</small>
                </div>
              </div>
              ...
              <div className='button-container mt-6 space-y-3'>
                ...
                <div className='form-group'>
                  ...
                  <small class="form-text text-muted">Fomat: www.websiteexample.com</small>
                </div>
              </div>
              ...
              <div className='flex justify-between !mt-6 w-full'>
                <button class="mb-2 mr-2 btn btn-light">Cancel</button>
                <button class="mb-2 mr-2 btn btn-primary">Send for review</button>
              </div>
