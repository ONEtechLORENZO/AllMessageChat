            ...
            <div className="!mt-4 grid grid-cols-12 items-center !gap-5">
                ...
                <div className="col-span-6 space-y-2">
                    ...
                    <div className="grid gap-2 grid-cols-2">
                        <button type="button" className="btn btn-primary">Create New Catalog</button>
                        <button type="button" className="w-full  justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">Import catalog</button>
                    </div>
