                        ...
                        <div className="flex justify-between items-center w-full">
                            <div className="flex justify-center items-center gap-4">
                                ...
                                <div className="widget-chart-content">
                                    ...
                                    <div className="text-2xl font-medium !mt-0 ">
                                         <span class="">  {props.total_session_limit - props.current_session_count} sessions  </span>
                                    </div>
                                    <div className='text-[#878787] text-base font-normal'>
                                ...
                                >
                                    <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                        ...
                                        <div className='!mt-8'>
                                            ...
                                            <div className='!mt-8'>
                                                <div class="form-check form-check-inline"><input type="checkbox" class="form-check-input !mt-[6px]" /><label class="form-check-label text-[#424242] font-medium text-base">{props.translator['Set monthly auto-recharge']}</label></div>
                                            ...
                                            <div className='!mt-8'>
                                                <div class="form-check form-check-inline"><input type="checkbox" class="form-check-input !mt-[6px]" /><label class="form-check-label "><div>
