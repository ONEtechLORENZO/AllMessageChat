...
export default function DashboardNew(props) {
    ...
    function handleEvent(event, picker) {       
        var url = route('dashboard', {'module' : 'Msg', 'is_conversation' : true ,'start_date': picker.startDate.format('YYYY/MM/DD'), 'end_date': picker.endDate.format('YYYY/MM/DD')});
        Inertia.get(url);
    }
    ...
    <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div className="pb-4">
                <h3 className="text-2xl leading-6 font-semibold text-[#393939]">{props.translator['Dashboard']}</h3>
            </div>
            <div className='grid grid-cols-3 gap-4'>
                ...
                <GlassCard className="col-span-2">
                    ...
                    <div className='grid grid-cols-2 divide-x gap-3'>
                        <div>
                            <div className='text-[#363740] text-base font-medium'>
                                {props.translator['Conversations of this month']}
                            </div>
                            <div className='flex justify-between'>
                                <div>
                                    ...
                                    <div className='text-[#363740] font-semibold text-4xl'>
                                        {(messageDetails.total_messages) ? (messageDetails.total_messages):'-'}
                                ...
                                <div>
                                    ...
                                    <div>
                                    {(messageDetails.total_messages) ? (messageDetails.total_messages/30).toFixed(3):'-'}
                                    </div> 
                            </div>  
                        </div>
                        <div className='grid  divide-x gap-3'>                                    
                                    <div className="flex justify-center text-base">
                                        <div className="text-[#878787] pr-5"> 
                                        <div>{props.translator['Trend']}</div>
                                        
                                        <ReactEcharts
                                            option={options}
                                            className="flex justify-right align-right text-base"
                                            style={{ width: "340px", height: "180px",color:"orange" }}
                                         />
                                         </div>
                                </div>
                                    </div>
                        ...
                        <div className='divide-y p-4'>
                            ...
                            <div className="flex justify-between p-4">
                                <div className="flex items-center flex-col justify-center space-y-1 gap-2">
                                    ...
                                    />
                                    <div className="flex justify-center  text-base">
                                     <div className="pr-2">{(props.services.instagram) ? (props.services.instagram).count :'-' } </div>
                               ...
                               <div className="flex items-center flex-col justify-center space-y-1 gap-2">
                                    ...
                                    />
                                    <div className="flex justify-center text-base">
                                        <div className="pr-2">{(props.services.whatsapp) ? (props.services.whatsapp).count :'-' }</div>
                                ...
                                <div className="flex items-center flex-col justify-center space-y-1 gap-2">
                                    ...
                                    />
                                    <div className="flex justify-center text-base">
                                       <div className="pr-2">{(props.services.telegram) ? (props.services.telegram).count :'-' }</div>
                                ...
                                <div className="flex items-center flex-col justify-center space-y-1 gap-2">
                                    <img
                                        ...
                                        className="w-8"
                                    />
                                    <div className="flex justify-centertext-base">
                                      <div className="pr-2">{(props.services.facebook) ? (props.services.facebook).count :'-' }</div> 
                            ...
                            <div className="flex justify-center items-center gap-4">
                                ...
                                <div className="widget-chart-content">
                                    ...
                                    <div className='flex gap-2 items-center '>
                                        ...
                                        <FaPlusCircle className='text-[#545CD8] cursor-pointer' onClick={openModal} />
                                    </div>
                                    <div className='text-[#878787] text-base font-normal'>
                                    {props.translator['Manual recharge']}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex justify-center items-center gap-4">
                                <div className="w-[60px] h-[60px] rounded-lg  flex justify-center items-center">
                                    <svg width={49} height={48} viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="0.666687" width={48} height={48} rx={8} fill="#1C9AE1" fillOpacity="0.2" />
                                        <path d="M18.0716 11.1721V26.1001H11.6746C11.6746 26.1001 11.6746 32.6891 11.6746 34.8181C11.6746 36.9471 13.6576 37.8281 15.1266 37.8281C16.5956 37.8281 31.3866 37.8281 35.1326 37.8281C36.7486 37.8281 38.3316 36.2561 38.3316 34.6291C38.3316 33.4541 38.3316 11.1721 38.3316 11.1721H18.0726H18.0716ZM15.1266 36.7621C14.4626 36.7621 12.7416 36.4131 12.7416 34.8181V27.1661H18.0726V34.3581C18.0726 35.0721 17.1396 36.7621 15.6686 36.7621H15.1266ZM37.2646 34.6291C37.2646 35.6651 36.1686 36.7621 35.1316 36.7621H18.0186C18.7366 36.0141 19.1376 35.0311 19.1376 34.3581V12.2381H37.2636V34.6291H37.2646Z" fill="#3F87AF" />
                                        <path d="M21.2706 14.3711H35.1316V15.4371H21.2706V14.3711Z" fill="#3F87AF" />
                                        <path d="M21.2706 28.7649H35.1316V29.8309H21.2706V28.7649Z" fill="#3F87AF" />
                                        <path d="M21.2706 32.4971H35.1316V33.5631H21.2706V32.4971Z" fill="#3F87AF" />
                                        <path d="M35.1316 18.1021H21.2706V26.0991H35.1316V18.1021ZM34.0656 25.0331H22.3366V19.1691H34.0656V25.0331Z" fill="#3F87AF" />
                                    </svg>
                                ...
                                <div className="widget-chart-content">
                                    ...
                                    <div className="text-2xl font-medium !mt-0 ">
                                         <span className="">  {props.total_session_limit - props.current_session_count} sessions  </span>
                                    </div>
                                    <div className='text-[#878787] text-base font-normal'>
                                        You spent {props.current_session_count} of {props.total_session_limit} sessions
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center w-full">
                            <div className="flex justify-center items-center gap-4">
                                ...
                                <div className="widget-chart-content">
                                    ...
                                    <div className="text-2xl font-medium !mt-0 ">
                                    ${messageDetails.total_amount ? <>{(messageDetails.total_amount).toFixed(3)}</> : 0 }
                                    </div>
                                    <div className='text-[#878787] text-base font-normal'>
                                    {props.translator['look closely']}
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                        <div className='flex justify-center items-center gap-2 flex-col'>
                                            <svg width={48} height={48} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M26.6761 16.1326C24.0706 16.1326 21.9556 18.2461 21.9556 20.8531C21.9556 23.4601 24.0706 25.5751 26.6761 25.5751C29.2846 25.5751 31.3966 23.4616 31.3966 20.8531C31.3966 18.2446 29.2831 16.1326 26.6761 16.1326ZM26.6761 24.0001C24.9421 24.0001 23.5291 22.5886 23.5291 20.8516C23.5291 19.1146 24.9406 17.7046 26.6761 17.7046C28.4131 17.7046 29.8231 19.1161 29.8231 20.8516C29.8231 22.5871 28.4116 24.0001 26.6761 24.0001Z" fill="#178C3F" />
                                                <path d="M7.79395 9.05103V32.6535H45.5579V9.05103H7.79395V9.05103ZM43.9859 14.3745V31.08H9.36894V10.6245H43.9859V14.3745V14.3745Z" fill="#178C3F" />
                                                <path d="M37.119 34.2285H6.22047V12.1995H4.64697V35.802H42.4125V34.2285H40.839H37.119Z" fill="#178C3F" />
                                                <path d="M33.972 37.3754H3.0735V15.3464H1.5V38.9489H39.2655V37.3754H37.692H33.972Z" fill="#178C3F" />
                                                <path d="M11.7285 12.2476H16.449V13.8211H11.7285V12.2476V12.2476Z" fill="#178C3F" />
                                                <path d="M11.7285 27.9346H16.449V29.5081H11.7285V27.9346V27.9346Z" fill="#178C3F" />
                                                <path d="M36.9045 12.2476H41.625V13.8211H36.9045V12.2476Z" fill="#178C3F" />
                                                <path d="M36.9045 27.9346H41.625V29.5081H36.9045V27.9346Z" fill="#178C3F" />
                                            </svg>
                                            <div className='text-[#363740] font-medium text-2xl'>€374,72</div>
                                            <div className='text=[#424242] text-2xl font-bold'>{props.translator['Recharge your balance']}</div>

                                        </div>

                                        <div className='!mt-8'>
                                            <div>{props.translator['Recharge manually']}</div>

                                            <div className='flex justify-center items-center gap-2 flex-col w-[200px] mx-auto'>
                                                <label>{props.translator['Enter the amount:']}</label>

                                                <div className='w-[200px] relative'>
                                                    <span className='absolute inset-y-0 flex items-center left-2'>€</span>
                                                    <input type={'text'} className="rounded-md w-full !pl-4 pr-12" />
                                                    <span className='absolute inset-y-0 flex items-center right-2 tracking-tighter'>{props.translator['min']} 50</span>
                                                </div>
                                                <div className='w-full'>
                                                    <button type='button' className='w-full btn btn-primary text-center'>{props.translator['Charge']}</button>
                                                </div>


                                            </div>
                                            <div className='!mt-8'>
                                                <div className="form-check form-check-inline"><input type="checkbox" className="form-check-input !mt-[6px]" /><label className="form-check-label text-[#424242] font-medium text-base">{props.translator['Set monthly auto-recharge']}</label></div>
                                                ...
                                                <div className='flex justify-center items-center gap-2 flex-col w-[200px] mx-auto !mt-4'>
                                                    ...
                                                    <div className='w-full'>
                                                        <button type='button' className='w-full btn btn-primary text-center'>{props.translator['Set auto-recharge']}</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className='!mt-8'>
                                                <div className="form-check form-check-inline"><input type="checkbox" className="form-check-input !mt-[6px]" /><label className="form-check-label "><div>
                                                    <div className='text-[#424242] font-medium text-base'>{props.translator['Set threshold auto-recharge']}</div>
                                                    <div className='text-[#7E7F8C] font-medium text-sm'>{props.translator['Set the minimum threshold from which to automatically reload']}</div>

                                                </div></label></div>

                                                <div className='flex justify-center items-center gap-2 flex-col w-[200px] mx-auto !mt-4'>
                                                    <label className='font-medium'>{props.translator['Set threshold']}</label>
                                                    ...
                                                    <label className='font-medium'>{props.translator['Set monthly limit to charge']} </label>

                                                    <div>
                                                        <div className="form-check form-check-inline">
                                                            <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" defaultValue="option1" />
                                                            <label className="form-check-label" htmlFor="inlineRadio1">{props.translator['Disable']}</label>
                                                        </div>
                                                        <div className="form-check form-check-inline">
                                                            <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" defaultValue="option2" />
                                                            <label className="form-check-label" htmlFor="inlineRadio2">{props.translator['Active']}</label>
                                                        </div>
            ...
            <GlassCard className="col-span-2">
                ...
                <div className='flex gap-2 items-center'>
                    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.40375 2.40381C3.29918 2.40381 2.40375 3.29924 2.40375 4.40381V19.5963C2.40375 20.7009 3.29918 21.5963 4.40375 21.5963H19.5962C20.7008 21.5963 21.5962 20.7009 21.5962 19.5963V4.40381C21.5962 3.29924 20.7008 2.40381 19.5962 2.40381H4.40375ZM19.7968 3.20331C20.349 3.20331 20.7967 3.65102 20.7967 4.20331V6.80181H3.204V4.20331C3.204 3.65102 3.65171 3.20331 4.204 3.20331H19.7968ZM4.20325 20.7968C3.65096 20.7968 3.20325 20.3491 3.20325 19.7968V7.60206H20.796V19.7968C20.796 20.3491 20.3483 20.7968 19.796 20.7968H4.20325Z" fill="#363740" />
                        <path d="M8.40076 4.40332H9.60076V5.60257H8.40076V4.40332Z" fill="#363740" />
                        <path d="M14.3992 4.40332H15.5985V5.60257H14.3992V4.40332Z" fill="#363740" />
                        <path d="M9.261 10.4469C9.11775 11.4196 8.655 11.4369 7.7235 11.4706L7.57875 11.4759V12.1539H9.15675V16.5894H9.99375V10.3186H9.279L9.26025 10.4469H9.261Z" fill="#363740" />
                        <path d="M13.9815 12.3315C13.6095 12.3315 13.2277 12.453 12.9255 12.6563L13.2105 11.19H15.8467V10.395H12.5865L11.9505 13.791H12.6742L12.7185 13.722C12.9712 13.3283 13.4325 13.083 13.923 13.083C14.721 13.083 15.3 13.6733 15.3 14.4855C15.3 15.2205 14.8387 15.9645 13.9575 15.9645C13.2045 15.9645 12.663 15.456 12.6405 14.7278L12.636 14.5823H11.7997L11.8035 14.736C11.8305 15.921 12.6787 16.7168 13.9155 16.7168C15.162 16.7168 16.1377 15.7628 16.1377 14.5455C16.1377 13.221 15.2722 12.3308 13.9837 12.3308L13.9815 12.3315Z" fill="#363740" />
                    </svg>
