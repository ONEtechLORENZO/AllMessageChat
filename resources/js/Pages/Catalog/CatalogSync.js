                                                    ...
                                                    <tr key={record.field_name} >
                                                        <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                                                            ...
                                                            <div class="flex justify-between">
                                                                <div class="font-medium text-slate-900">{record.field_label} {record.is_mandatory ?  <span className='text-red-600'>*</span> : ''}</div>
                                                            </div>
                                                            <div class="mt-1 text-gray-500">{record.helpline}</div>
                       ...
                       <Menu.Item>
                        {({ active }) => (
                            <button className='flex gap-2 p-2 items-center' onClick={() => startSchedular(props.catalog)}>
                                <ClipboardListIcon className="h-5 w-5" aria-hidden="true" /> Schedule
                            </button>  
                        )}
                       </Menu.Item> 
                    : ''}
                       ...
                       <Menu.Item>
                        {({ active }) => (
                            <button className='flex gap-2 p-2 items-center' onClick={() => props.reScheduleCatalog(props.catalog)}>
                                <ClipboardListIcon className="h-5 w-5" aria-hidden="true" /> Re-schedule
                            </button>  
                        )}
                       </Menu.Item> 
                    : ''}
                    <Menu.Item>
                        {({ active }) => (
                          <button className='flex gap-2 p-2 items-center' onClick={() => props.fbFieldMapping(props.catalog)}>
                             <AdjustmentsIcon className="h-5 w-5" aria-hidden="true" /> Mapping
                          </button>  
                        )}
                    </Menu.Item>
                        ...
                        <Menu.Item>
                            {({ active }) => (
                                <button className='flex gap-2 p-2 items-center' onClick={() => props.HandleCatalogScheduling(props.catalog.id, 'inprogress')}>
                                    <FastForwardIcon className="h-5 w-5" aria-hidden="true" /> Start
                                </button>
                            )}
                        </Menu.Item>
                    : ''}
                        ...
                        <Menu.Item>
                            {({ active }) => (
                                <button className='flex gap-2 p-2 items-center' onClick={() => props.HandleCatalogScheduling(props.catalog.id, 'cancel')}>
                                    <XIcon className="h-5 w-5" aria-hidden="true" /> Cancel
                                </button>
                            )}
                        </Menu.Item>
                     </>
