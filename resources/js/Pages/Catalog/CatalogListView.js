...
import { BriefcaseIcon, SearchIcon, ColorSwatchIcon, DownloadIcon, DuplicateIcon } from '@heroicons/react/solid';
                    ...
                    <div className="!mt-4 grid grid-cols-12 !gap-5 px-2">
                        <div className="col-span-4 flex flex-col !gap-2">
                            ...
                            <div className="grid gap-2 grid-cols-2">
                                ...
                                > 
                                    <div className='flex justify-center items-center font-semibold'> <DownloadIcon className='h-4 w-4 mr-1' />Import Catalog </div>
                                </Button>
                            </div>
                        ...
                        <div className="col-span-8 space-y-2">
                            ...
                            <div className='grid grid-cols-2'>
                                <div className='flex justify-start'>
                                    ...
                                    > 
                                        <div className='flex justify-center items-center font-semibold'> <ColorSwatchIcon className='h-4 w-4 mr-1' />Add product</div>
                                    </Button>
                                </div>
                                <div className='flex justify-end '>
                                    <Button 
                                ...
                                <div className="flex items-center gap-1.5">
                                    <div className='flex gap-2 items-center'>            
                                        <div className="mt-1 relative align-self-start flex items-center gap-1.5">
                                            ...
                                            <SearchIcon className="h-5 w-5 text-gray-400" aria-hidden="true" onClick={searchHandler}/>
                                            </div>
                                            <Input 
                                                name="search"
                                                id="search"
            ...
            <div className='card !shadow-card !py-6 !px-4 !gap-4'>
                <div className='flex !gap-4'>
                    {record.media_id ? 
                      ...
                      <img  src={route('preview_document', record.media_id)} class={'w-auto h-[150px]'}/>
                          <div className='flex flex-col justify-between'>
                            {record.media && Object.entries(record.media).map( ([key, image]) => {
                                if(key < 4 && record.media_id == image.id) return false;
                                return (
                                    <img  src={route('preview_document', image.id)} class={'w-8 h-8'}/>
                                );
                            })}
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div className='flex !gap-1'>
                        <textarea
                            ...
                            readonly
                        />
                        <DuplicateIcon className='h-5 w-5 text-indigo-500 hover:text-indigo-700' onClick={() => clickToCopy('description')}/>
                    </div>
                ...
                <div>
                    ...
                    <div className='flex !gap-1'>
                        <input
                            ...
                            readOnly
                        />
                        <DuplicateIcon className='h-5 w-5 text-indigo-500 hover:text-indigo-600' onClick={() => clickToCopy('url')}/>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <td>
                                        <div className='flex items-center !gap-2 '>
                                            <div>
                                                {(product.media_id) ? 
                                                    <div>
                                                        <img  src={route('preview_document', product.media_id)} class={'object-cover w-8 h-8 rounded-full'}/>
                                                    </div>
                                                    :
                                                    <div>
