            ...
            <div className="flex">
                ...
                <div className="w-2/3">
                    <div className="flex-1 p:2 sm:p-3 pr-0 justify-between flex flex-col h-screen bg-gray-100">
                        ...
                        <div
                            id="messages"
                            className="flex flex-col flex-1 justify-end space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch"
                        >
