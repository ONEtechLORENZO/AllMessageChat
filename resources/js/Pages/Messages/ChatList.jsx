                                                    ...
                                                    { (containerCategory == 'whatsapp' && selectedAccount && selectedContact ) &&
                                                            <>
                                                                {(props.sessions[selectedContact] && props.sessions[selectedContact][selectedAccount]) ?
                                                                    <span title='Session active' className="rounded-full p-1 bg-green-500 m-2"></span>
                                                                    :
                                                                    <span title='Session inactive' className="rounded-full p-1 bg-red-500 m-2"></span>
                                                                }
                                                            </>
                                                    }
                                                                ...
                                                                {(containerCategory == 'whatsapp' && selectedContact && selectedContact) &&
                                                                    <>
                                                                        {(props.sessions[selectedContact] && props.sessions[selectedContact][id]) ?
                                                                            <span title='Session active' className="rounded-full p-1 bg-green-500"></span>
                                                                            :
                                                                            <span title='Session inactive' className="rounded-full p-1 bg-red-500"></span>
                                                                        }
                                                                    </>
                                                                }
