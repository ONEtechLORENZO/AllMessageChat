                          ...
                          <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
                              ...
                              >
                                  <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-xl sm:w-full">
                                      <div className="bg-gray-50 pb-4 sm:p-4 sm:pb-4">
                                                        ...
                                                        {Object.entries(props.options).map(([key, option]) => {
                                                          ...
                                                          return(
                                                            <li className="border-1 border-gray-100">
                                                                <input type="radio" id={option.name} name="trigger" value={option.name} className="hidden peer" onClick={() => props.saveData( props.type, option.name, props.nodeId)} required />
