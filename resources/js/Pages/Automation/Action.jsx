                                                        ...
                                                        <div>
                                                            <div className="flex flex-wrap mx-3 mb-6">
                                                                ...
                                                                <Dropdown
                                                                    ...
                                                                    required={ true }
                                                                />
                                                                <p className="text-gray-600 text-xs italic">Send a message using the selected account</p>
                                                                </div>
                                                            </div>
                                                            <div className="flex flex-wrap mx-3 mb-6">
                                                                <div className="w-full px-3">
                                                                ...
                                                                <Dropdown
                                                                    ...
                                                                    required={ true }
                                                                />
                                                                <p className="text-gray-600 text-xs italic">Send a message using the template</p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div>
                                                            <div className="flex flex-wrap -mx-3 mb-6">
                                                                ...
                                                                <Dropdown
                                                                    ...
                                                                    required={ true }
                                                                />
                                                                <p className="text-gray-600 text-xs italic">Relate the tag to the contact</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    }
                                                        ...
                                                        <div>
                                                            <div className="flex flex-wrap -mx-3 mb-6">
                                                                ...
                                                                <Dropdown
                                                                    ...
                                                                    required={ true }
                                                                />
                                                                <p className="text-gray-600 text-xs italic">Relate the List to the contact</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    }
