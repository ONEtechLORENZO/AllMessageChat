        ...
        <div className='w-4/5 card !p-2 !mt-4 text-xs text-black ml-2'>
            {props.template.header_type == 'image' && 
              <div className='object-cover !mb-1 !rounded bg-gray-200 flex justify-content-center h-32 items-center'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="#e5e7eb" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" className="fill-[#e5e7eb] stroke-[#afafaf] h-16 w-16">
            ...
            {props.template.header_type == 'video' && 
              <div className='object-cover !mb-1 !rounded bg-gray-200 flex justify-content-center h-32 items-center'>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="#e5e7eb" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" className="fill-[#e5e7eb] stroke-[#afafaf] h-16 w-16">
