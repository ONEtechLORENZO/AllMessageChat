        ...
        <>
            ...
            {props.data.button_type == 'Quick Reply' ?                                         
                <div className="form-group col-span-6 sm:col-span-4">
                    ...
                    <small class="form-text text-muted"> {props.quick_reply_max_length - props.data.button_text.length} / {props.quick_reply_max_length} </small>
                    ...
                    {props.data.action == 'call_phone_number' ?
                        <>
                            ...
                            <div className="form-group col-span-6 sm:col-span-4">
                                ...
                                <small class="form-text text-muted">Max {props.quick_reply_max_length - props.data.phone_number.length} characters </small>
                    ...
                    {props.data.action == 'visit_website' ? 
                        <>
                            ...
                            <div className="form-group col-span-6 sm:col-span-4">
                                ...
                                <small class="form-text text-muted"> {props.url_max_length - props.data.url.length} / {props.url_max_length} </small>
