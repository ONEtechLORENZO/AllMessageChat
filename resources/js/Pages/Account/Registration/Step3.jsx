...
const checklist = [
    {
        name: "accept",
        description: "Accept WA Business Policy & Commerce Policy",
        value: "",
    },
    {
        name: "condition",
        description: "OneMessage Terms & Conditions and Privacy Policy",
        value: " ",
    },
    {
        name: "confirm",
...
export default function Step3(props) {
    const categoryOption = {
        ...
        "Event Planning and Service":
            props.translator["Event Planning and Service"],
        ...
        "Travel and Transportation":
            props.translator["Travel and Transportation"],
        Restaurant: props.translator["Restaurant"],
        Other: props.translator["Other"],
    };
    const formField = [
        {
            label: props.translator["Business Category"],
            name: "category",
            type: "dropdown",
        },
        {
            label: props.translator["Business Description"],
            name: "description",
            type: "textarea",
        },
    ];
    ...
    const addformField = [
        {
            label: props.translator["Business Phone Number"],
            name: "phone_number",
            type: "phone_number",
            mandatory: 1,
        },
        {
            label: props.translator["Legal Entity Name"],
            name: "company_name",
            type: "text",
            mandatory: 1,
        },
        {
            label: props.translator["Legal Business Name"],
            name: "display_name",
            type: "text",
            mandatory: 1,
        },
        ...
        <div className="p-4">
            <div>
                <h2 className="text-2xl font-medium text-white">
                    {props.translator["Register Phone Number"]}
                </h2>
                <p className="text-[#878787] text-sm">
                    {
                        props.translator[
                            "Fill out the form accurately, we will send this data to whats app to verify your credentials."
                        ]
                    }
                </p>
            </div>
            ...
            <div className="overflow-hidden  md:rounded-lg mt-6">
                <div className="space-y-6">
                    {fieldList.map((field) => {
                        ...
                        const field_value = props.data[field_name];
                        ...
                        return (
                            ...
                            >
                                <div className="whitespace-nowrap text-base font-medium text-white">
                                    {field.label}
                                    {field.mandatory == 1 && (
                                ...
                                <div className="whitespace-nowrap text-sm text-[#878787]">
                                    {field.type == "text" ? (
                                        <Input
                                            type="text"
                                    ...
                                    {field.name == "display_name" ? (
                                        <span className="text-[#878787]">
                                            {
                                                props.translator[
                                                    "if different from legal entity name, add a link that shows that you own that brand"
                                                ]
                                            }
                                        </span>
                                    ) : (
                    ...
                    {fieldList.length > 3 ? (
                        <div className="">
                            <div className="whitespace-nowrap text-sm text-[#878787] col-span-2 space-y-2">
                                <p>
                                    <span className="text-red-500">Note: </span>
                                    <span className="text-[#878787] text-sm">
                                        {
                                            props.translator[
                                                "Make sure to enter a Business Description that is consistent with the"
                                            ]
                                        }
                                        <br></br>
                                        {
                                            props.translator[
                                                "information show on your website and that is adherent to Whatsapp Policies."
                                            ]
                                        }
                                    </span>
                                </p>
                                <p className="text-[#878787]">
                                    {props.translator["Go to"]} FAQ
                                </p>
                            </div>
                        </div>
                    ) : (
            ...
            <div className="mt-4 space-y-2">
                <div className="form-check !pl-0">
                    ...
                    />
                    <label className="form-check-label inline-block text-white px-4">
                        {props.translator["Accept"]}{" "}
                        <a
                            className="text-[#878787] underline px-2"
                            href="https://www.whatsapp.com/legal/business-policy/"
                            target="_blank"
                        >
                            {props.translator["WA Business Policy"]}
                        </a>{" "}
                        &{" "}
                        <a
                            className="text-[#878787] underline px-2"
                            ...
                            target="_blank"
                        >
                            {props.translator["Commerce Policy"]}
                        </a>
                    </label>
                </div>
                <div className="form-check !pl-0">
                    ...
                    <label className="form-check-label inline-block text-white px-4">
                        ...
                        <a
                            className="text-[#878787] underline px-2"
                            href="https://www.gupshup.io/terms-and-conditions"
                            target="_blank"
                        >
                            {props.translator["Terms & Conditions"]}
                        </a>
                        {props.translator["and"]}
                        <a
                            className="text-[#878787] underline px-2"
                            href="https://www.gupshup.io/privacy-policy"
                            target="_blank"
                        >
                            {props.translator["Privary Policy"]}
                        </a>
                    </label>
                </div>
                <div className="form-check !pl-0">
            ...
            <div className="flex justify-between mt-14">
                <Link href={route("dashboard")} className="btn btn-light">
                    {props.translator["Cancel"]}
                </Link>
                <Button color="primary" onClick={() => props.saveAccount()}>
