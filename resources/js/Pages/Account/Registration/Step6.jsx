            ...
            <form id="form" className="p-2">
                <div>
                    <h3 className="text-white">
                        {props.translator["Link Whatsapp via WABA"]}
                    </h3>
                    <p className="text-[#878787]">
                        {
                            props.translator[
                                "Whatsapp Business API to unlock Whatsapp superpowers."
                            ]
                        }
                    </p>
                    <div className="text-center ">
                        ...
                        <div className="text-[#878787] m-1 p-4 text-start shadow-sm">
                            <p className="text-white">
                                {
                                    props.translator[
                                        "Meta, the company that manages whatsapp, allows the management of its APIs only through a few accredited business service providers (BSPs)."
                                    ]
                                }
                            </p>
                            <p className="text-white">
                                {
                                    props.translator[
                                        "A telephone number can only be managed by one BSP at a time."
                                    ]
                                }
                            </p>
                        </div>
                    </div>
                    <label className="text-base font-medium text-[#878787] text-center w-full mt-4">
                        {
                            props.translator[
                                "Have you ever registered your number to any BSP?"
                            ]
                        }
                    </label>
                ...
                <div className="text-center mt-6 text-white">
                    {props.translator["I am not sure"]}{" "}
                    <span className="text-indigo-300">
                        {" "}
                        {props.translator["Contact-us"]}{" "}
                    </span>
                </div>
                <div className="text-center mt-6 text-[#878787]">
                    {props.translator["What is a BSP?"]}
                </div>
            </form>

            <div className="flex mt-6 items-center text-[#878787]">
                <div className="flex justify-start w-2/3 items-stretch">
                    {props.translator["Not sure? Go to"]}{" "}
                    <a className="px-2 text-[#878787] underline" href="#">
                        {" "}
                        FAQ
                    </a>
                    {props.translator["or Get in Contact with"]}{" "}
                    <a className="px-2 text-[#878787] underline" href="#">
                        {" "}
                        {props.translator["Customer Service"]}
                    </a>
                </div>
