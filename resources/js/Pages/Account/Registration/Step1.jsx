            ...
            <form id="form p-2">
                <div className="flex">
                    <div className="p-2">
                        ...
                        <div className="pt-2 text-[#878787] text-sm">
                            {
                                props.translator[
                ...
                <div className="p-2 mt-4">
                    <div className="mx-auto w-1/2 flex flex-col justify-center">
                        <div className="text-lg text-[#878787] font-medium flex items-center">
                    ...
                    {props.error && (
                        <div className="text-[#878787] pt-4 text-sm mt-1 text-center">
                    ...
                    props.socialProfiles ? (
                        <>
                            <div className="mx-auto w-1/2 flex flex-col justify-center mt-3">
                                <div className="text-lg font-medium flex items-center text-[#878787]">
                                    {" "}
                                    {
                                        props.translator[
                                            "Choose Linked Profile"
                                        ]
                                    }{" "}
                                </div>
                                <div className="flex justify-start">
                        ...
                        <div className="text-[#878787] pt-4 text-sm mt-5">
                            WABA {props.translator["means"]} Whatsapp Business
                            API.<br></br>
                            {
                                props.translator[
