    ...
    return (
        <div>
                ...
                <div className="flex items-center justify-center h-screen">
                    <div className="p-1 rounded shadow-lg w-1/2 border-1 border-offset-2  bg-gradient-to-r from-blue-500 via-green-500 to-purple-500">
                        <div className="flex flex-col items-center p-4 space-y-2 bg-white">
                            {props.result == 'success' ?
                                ...
                                :
                                <svg xmlns="http://www.w3.org/2000/svg" className="text-red-600 w-28 h-28" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
