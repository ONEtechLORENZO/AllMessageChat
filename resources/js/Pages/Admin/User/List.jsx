                    ...
                    <ListViewTable
                        ...
                        renderActionCell={({ record }) => (
                            <div className="-mt-px flex divide-x divide-gray-200 justify-end">
                                ...
                                <a href="#" onClick={async (event) => { event.preventDefault(); if (await showThemedConfirm({ eyebrow: 'Delete', title: 'Confirm to Delete', message: 'Do you want delete the user?', confirmLabel: 'Confirm', cancelLabel: 'No' })) { removeUser(record.id); } }} className="px-2 text-indigo-600 hover:text-indigo-900">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
