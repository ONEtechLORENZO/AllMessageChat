                      ...
                      <div className="col-span-4 sm:col-span-1 form-group">
                        ...
                        <div className="col-span-4">
                          <label htmlFor="expiration-date" className="block text-sm font-medium text-gray-700">
                            SSL
                            <input class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300 " name='port_type' value="ssl" checked={data.port_type === "ssl"} required={true} type='radio' id='port_type' handleChange={handleChange} />
                          </label>
                        </div>
                        <div className="col-span-4">
                          <label>
                            TLS
                          <input class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300 " name='port_type' value="tls" checked={data.port_type === "tls"} required={true} type='radio' id='port_type' handleChange={handleChange} />
                          </label>
                        </div>
                      </div>
