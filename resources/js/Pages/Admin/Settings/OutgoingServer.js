                  ...
                  <div className="bg-white py-6 px-4 sm:p-6">
                    ...
                    <div className="mt-6 grid grid-cols-4 gap-6">
                      ...
                      <div className="col-span-4 sm:col-span-2 form-group">
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                        <Input name='driver' value={data.driver} required={true} type='text' id='driver' placeholder='Driver' handleChange={handleChange} />
                      </div>
                        <InputError message={errors.driver} />
                      </div>
                      <div className="col-span-4 sm:col-span-2"> </div>
                      <div className="col-span-4 sm:col-span-2 form-group">
                        <label htmlFor="server_name" className="block text-sm font-medium text-gray-700">
                          Server Name
                        </label>
                        <div className="mt-1 flex rounded-md shadow-sm">
