      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
          ...
          <tr>
            <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:26px;font-weight:300;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                <singleline>
                  <div mc:edit Simpli>
                  Congratulations on the creation of your new instance! We are excited to have you as a customer and are here to help you get the most out of <a href="http://OneMessage.Chat">OneMessage.Chat</a>.
                  Your instance is now ready for use and you can access it at {{$url}}. Please make sure to bookmark this URL for future reference.
                  To get started, simply log in using the credentials you used to sign up. If you have any questions or need assistance, our support team is available 24/7 to help you.
                  Thank you for choosing <a href="http://OneMessage.Chat">OneMessage.Chat</a>. We look forward to supporting you in your use of our platform.
                  </div>
                </singleline>
            </td>
          </tr>
