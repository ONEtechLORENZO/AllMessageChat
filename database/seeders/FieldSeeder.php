...
class FieldSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('fields')->insert([
            ...
            ['module_name' => 'Company', 'field_name' => 'status', 'field_label' => 'Status', 'field_type' => 'text', 'is_mandatory' => 0, 'is_custom' => 0, 'user_id' => 1, 'company_id' => 1,  'created_at' => $current_datetime, 'updated_at' => $current_datetime,'readonly_on_edit' => 'false', 'sequence' => '1'],
            ...
            ['module_name' => 'Company', 'field_name' => 'email', 'field_label' => 'Admin email for invoices', 'field_type' => 'email', 'is_mandatory' => 0, 'is_custom' => 0, 'user_id' => 1, 'company_id' => 1,  'created_at' => $current_datetime, 'updated_at' => $current_datetime,'readonly_on_edit' => 'false', 'sequence' => '1'], 
